import {
  ...
  postAttendanceService,
  getEmployeeByIdService,
  updateEmployeeDataService,
  getAllAttendancesFilterByDateService,
  loginService,
...
async function postAttendance(req, res, next) {
  ...
  try {
    const attendance = await postAttendanceService(
      employeeId,
      arrivalDate,
      arrivalTime,
      arrivalStatus,
...
async function updateEmployeeData(req, res, next) {
  ...
  try {
    const updatedEmployee = await updateEmployeeDataService(
      employeeId,
      oldPassword,
      newData
    );
...
async function getAllAttendancesFilterByDate(req, res, next) {
  try {
    ...
    const attendances = await getAllAttendancesFilterByDateService(
      startDate,
      endDate,
      employeeId
    );
